...
void paper_draw_source_pd_fit_pid()
{
  ...
  tr->Draw(str_draw.Data(),"am_fast>0.","colz");
  ...
  h->GetYaxis()->SetRangeUser(1, 120);
  h->GetXaxis()->CenterTitle();
  h->GetYaxis()->CenterTitle();

  h->Draw("colz");

  TLatex *tex_p = new TLatex(45, 100, "#gamma + CsI");
  TLatex *tex_a = new TLatex(80, 60, "#alpha + CsI");
  TLatex *tex_g = new TLatex(100, 25, "#gamma + PD");
