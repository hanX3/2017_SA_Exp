...
void paper_draw_qdc_pid_projection_230220()
{
  ...
  TH2D *h = new TH2D("h", "h", 400, 0, 40, 1000, 0, 500);
  tr->Draw("xx/36.:xx/(yy-180)>>h", "yy>180&&(xx/(yy+20.)>3.)&&(xx/(yy+100)<20.)", "colz");
  ...
  TLatex *tex_g = new TLatex(3,180,"#gamma + PD");
  TLatex *tex_label = new TLatex(3,400,"(b)");
